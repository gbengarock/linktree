...
const Links = () => {
  return (
    <div className='w-[80%] mx-auto flex-col py-2 mt-[-30px]'>
        ...
        <Button id='pitch' url='https://background.zuri.team' description='Background Check for Coders' title='Everything you need to know about that developer is right here' />
